...
- (void)viewDidLoad {
    ...
    _title =[NSMutableArray arrayWithArray:@[@"片刻·阅读",@"片刻·电台",@"片刻·碎片",@"回声·音乐",@"设置"]];
    [self creatItems];
    [self changeUIValue];
}
...
-(void)creatItems{
 ...
 /*
   ...
   */
    backGround.image = [UIImage imageNamed: @"start"];
    backGround.alpha = 1;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //cell.imageView.image = [UIImage imageNamed: @"article_navbar"];
